  ...
  <div class="nb-card p-4 text-start shadow-sm border-0" style="position: relative; z-index: 1; background: var(--bs-card-bg); border-radius: 16px;">
    <div class="d-flex align-items-center justify-content-between mb-3 flex-wrap gap-2">
      <div>
        ...
        <p class="text-secondary mb-0" style="font-size:0.85rem;">Live geographic map with full <i class="bi bi-circle-fill me-1" style="color: #16a34a;"></i> Green (32), <i class="bi bi-circle-fill me-1" style="color: #9333ea;"></i> Purple (36), and <i class="bi bi-circle-fill me-1" style="color: #eab308;"></i> Yellow (16) metro track corridors & station popups.</p>
      </div>
      <div class="d-flex align-items-center gap-2 flex-wrap">
        <span class="badge text-white px-3 py-2 rounded-pill" style="background:#9333ea;"><i class="bi bi-circle-fill me-1 text-white"></i> Purple Line (36)</span>
